About azure-purview-catalog-feedstock
=====================================
...
Installing `azure-purview-catalog` from the `conda-forge/label/azure-purview-catalog_rc` channel can be achieved by adding `conda-forge/label/azure-purview-catalog_rc` to your channels with:

```
conda config --add channels conda-forge/label/azure-purview-catalog_rc
conda config --set channel_priority strict
```

Once the `conda-forge/label/azure-purview-catalog_rc` channel has been enabled, `azure-purview-catalog` can be installed with `conda`:
...
```
conda search azure-purview-catalog --channel conda-forge/label/azure-purview-catalog_rc
```

or with `mamba`:

```
mamba search azure-purview-catalog --channel conda-forge/label/azure-purview-catalog_rc
```
...
mamba repoquery search azure-purview-catalog --channel conda-forge/label/azure-purview-catalog_rc

# List packages depending on `azure-purview-catalog`:
mamba repoquery whoneeds azure-purview-catalog --channel conda-forge/label/azure-purview-catalog_rc

# List dependencies of `azure-purview-catalog`:
mamba repoquery depends azure-purview-catalog --channel conda-forge/label/azure-purview-catalog_rc
```
